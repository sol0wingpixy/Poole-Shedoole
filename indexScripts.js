		...
		for(var x=0;x<15;x++)
		{
			...
			for(i=0;i<fileIn.clubs.length;i++)
			{
				...
				if ((x == xe || (x == (xe + 7) && !fileIn.clubs[i].weekly)) && fileIn.clubs[i].day.indexOf(day) != -1) {
					if (cDex>0) {
						startHrCon[conDex] = Math.max(startHrC, fileIn.clubs[i].hourStart);
						startMinCon[conDex] = Math.max(startMinC, fileIn.clubs[i].minStart);
						...
						if (startHrCon > endHrCon || (startHrCon == endHrCon && startMinCon >= endMinCon)) {
							...
							startHr = Math.max(fileIn.clubs[i].hourEnd + 1,startHr);
							if(startHr==fileIn.clubs[i].hourEnd + 1)
							...
							endMinC[cDex] = fileIn.clubs[i].minEnd;
							cDex++;
						}
						else
						{
			...
			for(var i=0;i<fileIn.sports.length;i++) {
				for (xe = 0; xe < 7; xe++)
				{
					if ((x == (xe+1) || x == (xe+8)) && fileIn.sports[i].hourEnd[xe] > 0)//monday
					{
						if (sDex > 0) {
							startHrCon[conDex] = Math.max(startHrC, fileIn.sports[i].hourStart[xe]);
							startMinCon[conDex] = Math.max(startMinC, fileIn.sports[i].minStart[xe]);
							endHrCon[conDex] = Math.min(endHrC, fileIn.sports[i].hourEnd[xe]);
							endMinCon[conDex] = Math.min(endMinC, fileIn.sports[i].minEnd[xe]);
							if (startHrCon > endHrCon || (startHrCon == endHrCon && startMinCon >= endMinCon)) {
								sportName[sDex] = fileIn.sports[i].name;
								startHr = Math.max(fileIn.sports[i].hourEnd[xe] + 1, startHr);
								if (startHr == fileIn.sports[i].hourEnd[xe] + 1)
									startMin = fileIn.sports[i].minEnd[xe];
								startHrS[sDex] = fileIn.sports[i].hourStart[xe];
								startMinS[sDex] = fileIn.sports[i].minStart[xe];
								endHrS[sDex] = fileIn.sports[i].hourEnd[xe];
								endMinS[sDex] = fileIn.sports[i].minEnd[xe];
								sDex++;
							}
							else {
								conDex++;
							...
							sportName[sDex] = fileIn.sports[i].name;
							startHr = fileIn.sports[i].hourEnd[xe] + 1;
							startMin = fileIn.sports[i].minEnd[xe];
							startHrS[sDex] = fileIn.sports[i].hourStart[xe];
							startMinS[sDex] = fileIn.sports[i].minStart[xe];
							endHrS[sDex] = fileIn.sports[i].hourEnd[xe];
...
Classes[i++]=({header: "English", name:"English 9 (LDTeam)", time: 75});//English 9 (LDTeam)
Classes[i++]=({header: "English", name:"English 9 (SCLD)", time: 0});//English 9 (SCLD)
Classes[i++]=({header: "English", name:"English 9 (CSS)", time: 30});//English 9 (CSS)
Classes[i++]=({header: "English", name:"English 9 (SCHI)", time: 90});//English 9 (SCHI)
Classes[i++]=({header: "English", name:"English 9 (SCSPED)", time: 30});//English 9 (SCSPED)
Classes[i++]=({header: "English", name:"Creative Writing (Fall/Spring)", time: 15});//Creative Writing (Fall/Spring)
Classes[i++]=({header: "English", name:"Developmental Reading", time: 0});//Developmental Reading
Classes[i++]=({header: "English", name:"Journalism I", time: 35});//Journalism I
Classes[i++]=({header: "English", name:"Photojournalism I", time: 35});//Photojournalism I
Classes[i++]=({header: "English", name:"Film Study (F/S)", time: 15});//Film Study (F/S)
...
/*done*/
Classes[i++]=({header: "English", name:"ESOL Level 2/3 Beg/Developing", time: 60});//ESOL Level 2/3 Beg/Developing
//Classes[i++]=({header: "English", name:"", time: 60});//Default Class Thingy I Guess
Classes[i++]=({header: "English", name:"ESOL Level 3 Developing", time: 60});//ESOL Level 3 Developing
Classes[i++]=({header: "English", name:"ESOL Level 4 Expanding", time: 60});//ESOL Level 4 Expanding
Classes[i++]=({header: "English", name:"English 9 Transitional (ESOL)", time: 60});//English 9 Transitional (ESOL)
Classes[i++]=({header: "English", name:"Individualized Math", time: 60});//Individualized Math
Classes[i++]=({header: "English", name:"Strategies for Success ESOL", time: 60});//Strategies for Success ESOL

//SCIENCE
/*done*/
Classes[i++]=({header: "Science", name:"Biology 1", time: 38});//Biology 1
Classes[i++]=({header: "Science", name:"Biology 1 HN", time: 60});//Biology 1 HN
Classes[i++]=({header: "Science", name:"Biology 1 (LD Team)", time: 38});//Biology 1 (LD Team)
Classes[i++]=({header: "Science", name:"Biology (SCLD)", time: 50});//Biology (SCLD)
Classes[i++]=({header: "Science", name:"Biology (CSS)", time: 50});//Biology (CSS)
Classes[i++]=({header: "Science", name:"Biology (SCHI)", time: 50});//Biology (SCHI)
Classes[i++]=({header: "Science", name:"Biology (SCSPED)", time: 50});//Biology (SCSPED)
Classes[i++]=({header: "Science", name:"Biology (ESOL Team)", time: 50});//Biology (ESOL Team)

//SOCIAL STUDIES
/*done*/
Classes[i++]=({header: "Social Studies", name:"World History & Geography 1", time: 180});//World History & Geography 1
Classes[i++]=({header: "Social Studies", name:"World History & Geography 1 (HN (stand alone)", time: 380});//World History & Geography 1 (HN (stand alone)
Classes[i++]=({header: "Social Studies", name:"World History & Geography 1 (LDTeam)", time: 180});//World History & Geography 1 (LDTeam)
Classes[i++]=({header: "Social Studies", name:"World History & Geography 1 (SCLD)", time: 75});//World History & Geography 1 (SCLD)
Classes[i++]=({header: "Social Studies", name:"World History & Geography 1 (CSS)", time: 60});//World History & Geography 1 (CSS)
Classes[i++]=({header: "Social Studies", name:"World History & Geography 1 (SCHI)", time: 0});//World History & Geography 1 (SCHI)
Classes[i++]=({header: "Social Studies", name:"World History & Geography 1 (SCSPED)", time: 0});//World History & Geography 1 (SCSPED)
Classes[i++]=({header: "Social Studies", name:"World History & Geography 1 (ESOL Team)", time: 0});//World History & Geography 1 (ESOL Team)
Classes[i++]=({header: "Social Studies", name:"World History & Geography 2", time: 120});//World History & Geography 2
Classes[i++]=({header: "Social Studies", name:"World History & Geography 2 HN", time: 180});//World History & Geography 2 HN

//MATHEMATICS
/*done*/
Classes[i++]=({header: "Mathematics", name:"Algebra 1", time: 90});//Algebra 1
Classes[i++]=({header: "Mathematics", name:"Algebra 1 HN", time: 90});//Algebra 1 HN
Classes[i++]=({header: "Mathematics", name:"Algebra 1 (LD Team)", time: 90});//Algebra 1 (LD Team)
Classes[i++]=({header: "Mathematics", name:"Algebra 1 (SCLD)", time: 90});//Algebra 1 (SCLD)
Classes[i++]=({header: "Mathematics", name:"Algebra 1 (CSS)", time: 120});//Algebra 1 (CSS)
Classes[i++]=({header: "Mathematics", name:"Algebra 1 (SCHI)", time: 120});//Algebra 1 (SCHI)
Classes[i++]=({header: "Mathematics", name:"Algebra 2", time: 90});//Algebra 2
Classes[i++]=({header: "Mathematics", name:"Algebra 2 HN", time: 90});//Algebra 2 HN
Classes[i++]=({header: "Mathematics", name:"Geometry", time: 100});//Geometry
Classes[i++]=({header: "Mathematics", name:"Geometry HN", time: 45});//Geometry HN
Classes[i++]=({header: "Mathematics", name:"Geometry (LDTeam)", time: 100});//Geometry (LDTeam)
Classes[i++]=({header: "Mathematics", name:"Geometry (SCLD)", time: 100});//Geometry (SCLD)
Classes[i++]=({header: "Mathematics", name:"Geometry (CSS)", time: 75});//Geometry (CSS)
Classes[i++]=({header: "Mathematics", name:"Geometry (SCHI)", time: 0});//Geometry (SCHI)
Classes[i++]=({header: "Mathematics", name:"Geometry/Pt 1 (SCHI)", time: 0});//Geometry/Pt 1 (SCHI)
Classes[i++]=({header: "Mathematics", name:"Computer Science", time: 45});//Computer Science

//WORLD LANGUAGES
/*done*/
Classes[i++]=({header: "World Languages", name:"French 1", time: 50});//French 1
Classes[i++]=({header: "World Languages", name:"French 2", time: 50});//French 2
Classes[i++]=({header: "World Languages", name:"French 3", time: 60});//French 3
Classes[i++]=({header: "World Languages", name:"German 1", time: 50});//German 1
Classes[i++]=({header: "World Languages", name:"German 2", time: 50});//German 2
Classes[i++]=({header: "World Languages", name:"German 3", time: 60});//German 3
Classes[i++]=({header: "World Languages", name:"Latin 1", time: 30});//Latin 1
Classes[i++]=({header: "World Languages", name:"Latin 2", time: 60});//Latin 2
Classes[i++]=({header: "World Languages", name:"Latin 3", time: 75});//Latin 3
Classes[i++]=({header: "World Languages", name:"Spanish 1", time: 50});//Spanish 1
Classes[i++]=({header: "World Languages", name:"Spanish 2", time: 60});//Spanish 2
Classes[i++]=({header: "World Languages", name:"Spanish 3", time: 75});//Spanish 3
Classes[i++]=({header: "World Languages", name:"American Sign Language 1", time: 50});//American Sign Language 1
Classes[i++]=({header: "World Languages", name:"American Sign Language 2", time: 50});//American Sign Language 2
Classes[i++]=({header: "World Languages", name:"Italian 1", time: 20});//Italian 1
Classes[i++]=({header: "World Languages", name:"Italian 2", time: 20});//Italian 2

//HEALTH AND PHYSICAL EDUCATION
/*done*/
Classes[i++]=({header: "Health and Physical Education", name:"HPE 9 ", time: 10});//HPE 9
Classes[i++]=({header: "Health and Physical Education", name:"Adapted PE (9/10)", time: 0});//Adapted PE (9/10)
Classes[i++]=({header: "Health and Physical Education", name:"Sports Medicine", time: 20});//Sports Medicine

//STUDENT RESOURCES
/*INCOMPLETE*/
//Classes[i++]=({header: "Student Resources", name:"Developmental Reading (SCLD)", time: 0});//Developmental Reading (SCLD)
//Classes[i++]=({header: "Student Resources", name:"Developmental Reading (SCSPED)", time: 0});//Developmental Reading (SCSPED)
Classes[i++]=({header: "Student Resources", name:"Developmental Reading (CSS)", time: 0});//Developmental Reading (CSS)
//Classes[i++]=({header: "Student Resources", name:"Developmental Reading (SCHI)", time: 0});//Developmental Reading (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Literacy LAB 1 (SCHI)", time: 0});//Literacy LAB 1 (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Literacy LAB 2 (SCLD)", time: 0});//Literacy LAB 2 (SCLD)
Classes[i++]=({header: "Student Resources", name:"Algebra 1 Part 1 (SCLD)", time: 60});//Algebra 1 Part 1 (SCLD)
Classes[i++]=({header: "Student Resources", name:"Algebra 1 Part 1 (CSS)", time: 40});//Algebra 1 Part 1 (CSS)
//Classes[i++]=({header: "Student Resources", name:"Algebra 1 Part 1 (SCHI)", time: 0});//Algebra 1 Part 1 (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Geometry/Part 1 (SCHI)", time: 10});//Geometry/Part 1 (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Individualized Math (SCLD)", time: 0});//Individualized Math (SCLD)
Classes[i++]=({header: "Student Resources", name:"Individualized Math (CSS)", time: 15});//Individualized Math (CSS)
//Classes[i++]=({header: "Student Resources", name:"Individualized Math (SCHI)", time: 0});//Individualized Math (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Individualized Math (SCSPED)", time: 0});//Individualized Math (SCSPED)
//Classes[i++]=({header: "Student Resources", name:"Economics & Personal Finance (SCSPED)", time: 0});//Economics & Personal Finance (SCSPED)
//Classes[i++]=({header: "Student Resources", name:"Strategies for Success (SCLD)", time: 0});//Strategies for Success (SCLD)
//Classes[i++]=({header: "Student Resources", name:"Strategies for Success (SCHI)", time: 0});//Strategies for Success (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Personal Development (SCSPED)", time: 0});//Personal Development (SCSPED)
Classes[i++]=({header: "Student Resources", name:"Personal Development (CEDSS)", time: 0});//Personal Development (CEDSS)
//Classes[i++]=({header: "Student Resources", name:"Personal Development (SCHI)", time: 0});//Personal Development (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Career Prep (1 pd)", time: 0});//Career Prep (1 pd)
//Classes[i++]=({header: "Student Resources", name:"Career Prep (2 pds)", time: 0});//Career Prep (2 pds)
//Classes[i++]=({header: "Student Resources", name:"Foundations of Science (SCSPED)", time: 0});//Foundations of Science (SCSPED)
//Classes[i++]=({header: "Student Resources", name:"Foundations of Science (SCHI)", time: 0});//Foundations of Science (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Foundations of English (SCSPED)", time: 0});//Foundations of English (SCSPED)
//Classes[i++]=({header: "Student Resources", name:"Foundations of English (SCHI)", time: 0});//Foundations of English (SCHI)
//Classes[i++]=({header: "Student Resources", name:"American Sign Language 1 (SCHI)", time: 0});//American Sign Language 1 (SCHI)
//Classes[i++]=({header: "Student Resources", name:"American Sign Language 2 (SCHI)", time: 0});//American Sign Language 2 (SCHI)
//Classes[i++]=({header: "Student Resources", name:"American Sign Language 3 (SCHI)", time: 0});//American Sign Language 3 (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Foundations of World History/Geo (SCSPED)", time: 0});//Foundations of World History/Geo (SCSPED)
//Classes[i++]=({header: "Student Resources", name:"Foundations of World History/ Geo (SCHI)", time: 0});//Foundations of World History/ Geo (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Life Skills (SCHI)", time: 0});//Life Skills (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Independent Living Skills", time: 0});//Independent Living Skills
//Classes[i++]=({header: "Student Resources", name:"Studio Art & Design 1 (SCSPED)", time: 0});//Studio Art & Design 1 (SCSPED)
Classes[i++]=({header: "Student Resources", name:"Studio Art & Design 1 (CSS)", time: 0});//Studio Art & Design 1 (CSS)
//Classes[i++]=({header: "Student Resources", name:"Studio Art & Design 1 (SCHI)", time: 0});//Studio Art & Design 1 (SCHI)
//Classes[i++]=({header: "Student Resources", name:"Theatre Arts 1 (SCHI)", time: 0});//Theatre Arts 1 (SCHI)
Classes[i++]=({header: "Student Resources", name:"Music Sampler (SPED)", time: 0});//Music Sampler (SPED)

//FINE ARTS: VISUAL ARTS
/*done*/
Classes[i++]=({header: "Fine and Visual Arts", name:"Studio Art & Design 1", time: 0});//Studio Art & Design 1
Classes[i++]=({header: "Fine and Visual Arts", name:"Computer Graphics 1", time: 0});//Computer Graphics 1
Classes[i++]=({header: "Fine and Visual Arts", name:"Photography 1", time: 25});//Photography 1
Classes[i++]=({header: "Fine and Visual Arts", name:"3-D Studio Art 1", time: 0});//3-D Studio Art 1

//FINE ARTS: PERFORMING ARTS
/*INCOMPLETE*/
Classes[i++]=({header: "Fine and Performing Arts", name:"Theatre Arts 1", time: 5});//Theatre Arts 1
Classes[i++]=({header: "Fine and Performing Arts", name:"Technical Theatre 1", time: 5});//Technical Theatre 1
Classes[i++]=({header: "Fine and Performing Arts", name:"Intermediate Band (Audition)", time: 100});//Intermediate Band (Audition)
Classes[i++]=({header: "Fine and Performing Arts", name:"Advanced Symphonic Band (Audition)", time: 100});//Advanced Symphonic Band (Audition)
Classes[i++]=({header: "Fine and Performing Arts", name:"Percussion Ensemble (Audition)", time: 100});//Percussion Ensemble (Audition)
Classes[i++]=({header: "Fine and Performing Arts", name:"Intermediate Orchestra (Audition)", time: 100});//Intermediate Orchestra (Audition)
Classes[i++]=({header: "Fine and Performing Arts", name:"Advanced Orchestra (Audition)", time: 120});//Advanced Orchestra (Audition)
//Classes[i++]=({header: "Fine and Performing Arts", name:"Chamber Ensemble (Audition)", time:0});//Chamber Ensemble (Audition)
Classes[i++]=({header: "Fine and Performing Arts", name:"Guitar 1", time: 0});//Guitar 1
Classes[i++]=({header: "Fine and Performing Arts", name:"Guitar 2 (Audition)", time: 0});//Guitar 2 (Audition)
Classes[i++]=({header: "Fine and Performing Arts", name:"Guitar 3 (Audition)", time: 0});//Guitar 3 (Audition)
Classes[i++]=({header: "Fine and Performing Arts", name:"Intermediate Women's Chorus (Audition)", time: 15});//Intermediate Women's Chorus (Audition)
Classes[i++]=({header: "Fine and Performing Arts", name:"Women's Chorus", time: 15});//Women's Chorus
Classes[i++]=({header: "Fine and Performing Arts", name:"Men's Chorus", time: 15});//Men's Chorus
Classes[i++]=({header: "Fine and Performing Arts", name:"Music Theory", time: 150});//Music Theory
Classes[i++]=({header: "Fine and Performing Arts", name:"Music Sampler 1 (SPED)", time: 0});//Music Sampler 1 (SPED)
...
//Classes[i++]=({header: "Business/Information Tech & Marketing", name:"Principles of Business and Marketing", time: 0});//Principles of Business and Marketing
//Classes[i++]=({header: "Business/Information Tech & Marketing", name:"Programming", time: 0});//Programming

//TECHNOLOGY AND ENGINEERING
/*done*/
Classes[i++]=({header: "Technology and Engineering", name:"Design & Technology", time: 0});//Design & Technology
Classes[i++]=({header: "Technology and Engineering", name:"Electronics 1", time: 0});//Electronics 1
Classes[i++]=({header: "Technology and Engineering", name:"Basic Technical Drawing", time: 25});//Basic Technical Drawing

//FAMILY & CONSUMER SCIENCES
/*done*/
Classes[i++]=({header: "Family & Consumer Sciences", name:"Gourmet & International Foods (full year)", time: 0});//Gourmet & International Foods (full year)
...
//*0*/Clubs[i++]=({name: "Astronomy Club", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Astronomy Club
//*0*/Clubs[i++]=({name: "Athletic Training Club", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Athletic Training Club
//*0*/Clubs[i++]=({name: "Band", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Band
/*1*/Clubs[i++]=({name: "Catholic Club", hourStart: 19, minStart: 30, hourEnd: 20, minEnd: 0, day: "Thu", weekly: true});//Catholic Club
//*0*/Clubs[i++]=({name: "Cavalcade (Newspaper)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Cavalcade (Newspaper)
//*0*/Clubs[i++]=({name: "Cavalier (Yearbook)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Cavalier (Yearbook)
/*1*/Clubs[i++]=({name: "Chess Club", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 30, day: "Mon", weekly: false});//Chess Club
//*0*/Clubs[i++]=({name: "Chorus", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Chorus
//*0*/Clubs[i++]=({name: "Class of 2016", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Class of 2016
//*0*/Clubs[i++]=({name: "Class of 2017", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Class of 2017
//*0*/Clubs[i++]=({name: "Class of 2018", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Class of 2018
//*0*/Clubs[i++]=({name: "Class of 2019", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Class of 2019
//*0*/Clubs[i++]=({name: "Color Guard", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Color Guard
/*1*/Clubs[i++]=({name: "Computer Science", hourStart: 16, minStart: 0, hourEnd: 17, minEnd: 0, day: "Thu", weekly: true});//Computer Science
/*1*/Clubs[i++]=({name: "Deaf Academic Bowl", hourStart: 15, minStart: 10, hourEnd: 17, minEnd: 0, day: "Wed", weekly: true});//Deaf Academic Bowl
//*0*/Clubs[i++]=({name: "DECA", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//DECA
//*0*/Clubs[i++]=({name: "DECA Officers", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//DECA Officers
/*1*/Clubs[i++]=({name: "Doctor Who Fan Club", hourStart: 15, minStart: 15, hourEnd: 16, minEnd: 30, day: "Wed", weekly: false});//Doctor Who Fan Club
/*1*/Clubs[i++]=({name: "Engineering Club/ACE Mentoring", hourStart: 16, minStart: 30, hourEnd: 18, minEnd: 0, day: "Wed", weekly: false});//Engineering Club/ACE Mentoring
//*0*/Clubs[i++]=({name: "Environment Club", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Environment Club
//*0*/Clubs[i++]=({name: "Family, Career and Community Leaders of America (FCCLA)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Family, Career and Community Leaders of America (FCCLA)
//*0*/Clubs[i++]=({name: "Fellowship of Christian Athletes", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Fellowship of Christian Athletes
/*1*/Clubs[i++]=({name: "French Club", hourStart: 15, minStart: 15, hourEnd: 16, minEnd: 0, day: "Wed", weekly: false});//French Club
//*0*/Clubs[i++]=({name: "French Honor Society", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//French Honor Society
/*1*/Clubs[i++]=({name: "Gay-Straight Alliance (GSA)", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 30, day: "Wed", weekly: false});//Gay-Straight Alliance (GSA)
/*1*/Clubs[i++]=({name: "German Club", hourStart: 15, minStart: 10, hourEnd: 16, minEnd: 0, day: "Wed", weekly: false});//German Club
/*1*/Clubs[i++]=({name: "German Honor Society", hourStart: 15, minStart: 10, hourEnd: 16, minEnd: 0, day: "Wed", weekly: false});//German Honor Society
/*1*/Clubs[i++]=({name: "Go Club", hourStart: 15, minStart: 10, hourEnd: 16, minEnd: 30, day: "Wed", weekly: true});//Go Club
//*0*/Clubs[i++]=({name: "Habitat for Humanity", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Habitat for Humanity
/*1*/Clubs[i++]=({name: "Hip Hop Club", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 30, day: "Tue", weekly: true});//Hip Hop Club
/*1*/Clubs[i++]=({name: "Improv Club", hourStart: 15, minStart: 10, hourEnd: 16, minEnd: 15, day: "Tue", weekly: true});//Improv Club
//*0*/Clubs[i++]=({name: "International Thespian Society", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//International Thespian Society
/*1*/Clubs[i++]=({name: "IT Girls", hourStart: 15, minStart: 0, hourEnd: 18, minEnd: 0, day: "Tue", weekly: false});//IT Girls
//*0*/Clubs[i++]=({name: "Key Club", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Key Club
//*0*/Clubs[i++]=({name: "KFC (Kosher Food Club)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//KFC (Kosher Food Club)
/*1*/Clubs[i++]=({name: "Latin Club", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 0, day: "Thu", weekly: true});//Latin Club
/*1*/Clubs[i++]=({name: "Latin Honor Society", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 0, day: "Mon", weekly: false});//Latin Honor Society
//*0*/Clubs[i++]=({name: "Leadership", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Leadership
//*0*/Clubs[i++]=({name: "Math Honor Society  (Mu Alpha Theta)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Math Honor Society  (Mu Alpha Theta)
/*1*/Clubs[i++]=({name: "Math Team (JV)", hourStart: 15, minStart: 10, hourEnd: 15, minEnd: 40, day: "Wed", weekly: false});//Math Team (JV)
/*1*/Clubs[i++]=({name: "Math Team (Varsity)", hourStart: 15, minStart: 0, hourEnd: 15, minEnd: 45, day: "Wed", weekly: false});//Math Team (Varsity)
/*1*/Clubs[i++]=({name: "Model United Nations", hourStart: 15, minStart: 30, hourEnd: 16, minEnd: 30, day: "Wed", weekly: true});//Model United Nations
/*1*/Clubs[i++]=({name: "National Art Honor Society", hourStart: 15, minStart: 30, hourEnd: 17, minEnd: 0, day: "Mon", weekly: false});//National Art Honor Society
/*1*/Clubs[i++]=({name: "National English Honor Society", hourStart: 15, minStart: 0, hourEnd: 15, minEnd: 45, day: "Tue", weekly: false});//National English Honor Society
//*0*/Clubs[i++]=({name: "National Honor Society", hourStart: 15, minStart: 0, hourEnd: 15, minEnd: 45, day: "Thu", weekly: false});//National Honor Society
/*1*/Clubs[i++]=({name: "Operation Patriot", hourStart: 15, minStart: 5, hourEnd: 15, minEnd: 30, day: "Wed", weekly: false});//Operation Patriot
//*0*/Clubs[i++]=({name: "Orchestra", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Orchestra
//*0*/Clubs[i++]=({name: "Page (Literary/Art Magazine)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Page (Literary/Art Magazine)
/*1*/Clubs[i++]=({name: "Photography Club ", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 0, day: "Wed", weekly: false});//Photography Club
/*1*/Clubs[i++]=({name: "Poetry Club ", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 0, day: "Mon", weekly: false});//Poetry Club
//*1*/Clubs[i++]=({name: "Relay for Life", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 0, day: "Wed", weekly: false});//Relay for Life
/*1*/Clubs[i++]=({name: "Robotics Club", hourStart: 15, minStart: 0, hourEnd: 18, minEnd: 0, day: "Tue, Thu", weekly: true});//Robotics Club
/*1*/Clubs[i++]=({name: "Scholastic Quiz Bowl /It's Academic", hourStart: 15, minStart: 10, hourEnd: 15, minEnd: 50, day: "Tue, Thu", weekly: true});//Scholastic Quiz Bowl /It's Academic
//*0*/Clubs[i++]=({name: "Science Olympiad", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Science Olympiad
/*1*/Clubs[i++]=({name: "Science National Honor Society", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 0, day: "Thu", weekly: false});//Science National Honor Society
/*1*/Clubs[i++]=({name: "Speech, Debate, & Forensics ", hourStart: 15, minStart: 10, hourEnd: 16, minEnd: 0, day: "Thu", weekly: true});//Speech, Debate, & Forensics
/*1*/Clubs[i++]=({name: "Spanish Club", hourStart: 15, minStart: 0, hourEnd: 16, minEnd: 30, day: "Wed", weekly: false});//Spanish Club
/*1*/Clubs[i++]=({name: "Spanish National Honor Society", hourStart: 15, minStart: 10, hourEnd: 16, minEnd: 0, day: "Wed", weekly: false});//Spanish National Honor Society
//*0*/Clubs[i++]=({name: "Student Advisory Council (SAC)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Student Advisory Council (SAC)
//*0*/Clubs[i++]=({name: "Student Government Association (SGA)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Student Government Association (SGA)
//*0*/Clubs[i++]=({name: "Students Against Destructive Decisions (SADD)", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Students Against Destructive Decisions (SADD)
/*1*/Clubs[i++]=({name: "Student 2 Student (Ambassadors) ", hourStart: 15, minStart: 30, hourEnd: 16, minEnd: 30, day: "Mon", weekly: false});//Student 2 Student (Ambassadors)
/*1*/Clubs[i++]=({name: "Technology Student Association (TSA)", hourStart: 15, minStart: 10, hourEnd: 16, minEnd: 10, day: "Wed", weekly: false});//Technology Student Association (TSA)
//*0*/Clubs[i++]=({name: "Tri M Music Honor Society", hourStart: 0, minStart: 0, hourEnd: 0, minEnd: 0, day: "", weekly: false});//Tri M Music Honor Society
